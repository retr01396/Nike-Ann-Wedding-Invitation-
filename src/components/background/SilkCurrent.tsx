...
export const SilkCurrent: React.FC = () => {
  ...
  return (
    // hidden on mobile — the 4 large will-change-transform layers (200vw×240vh)
    // create expensive compositor surfaces on phones. The WebGL canvas already
    // provides liquid-silk animation on all screens.
